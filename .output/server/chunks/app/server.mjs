import { defineComponent, h, inject, computed, unref, Suspense, Transition, provide, reactive, getCurrentInstance, ref, resolveComponent, shallowRef, useSSRContext, createApp, toRef, isRef, defineAsyncComponent, onErrorCaptured, nextTick, watchEffect, withCtx, createVNode } from 'vue';
...
const _routes = [
  {
    name: "brochure",
    path: "/brochure",
    file: "/Users/aron/Dropbox/Projects/Portfolio/pages/brochure.vue",
    children: [],
    meta,
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/brochure.73802760.mjs').then((m) => m.default || m)
  }
];
...
const plugins_artoolkit_worker_ts_RD5y8bveMS = {
  test() {
    console.log("test");
  }
};
const _plugins = [
  ...
  plugins_artoolkit_worker_ts_RD5y8bveMS
];
const _sfc_main$1 = {
  __name: "nuxt-root",
  __ssrInlineRender: true,
  setup(__props) {
    const ErrorComponent = defineAsyncComponent(() => import('./_nuxt/error-component.74f1b543.mjs').then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
